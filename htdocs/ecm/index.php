...
//FEDE
if (! empty($conf->salesorder->enabled))  { $rowspan++; $sectionauto[]=array('level'=>1, 'module'=>'salesorder','test'=>$conf->salesorder->enabled,'label'=>$langs->trans("SalesOrders"),       'desc'=>$langs->trans("ECMDocsBySalesOrders")); }
//FIN FEDE
