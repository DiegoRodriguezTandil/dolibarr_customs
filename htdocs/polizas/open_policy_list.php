...
//$sql.= "WHERE p.expiration_date < $todaysdate";
 //$sql.= ' WHERE p.fk_doctype = '.$todaysdate;
 //$sql.= "WHERE p.fk_doctype= '.$todaysdate";
//$sql.= " WHERE p.expiration_date LIKE '%".$db->escape($todaysdate)."%'"; 
 //$sql.= " WHERE p.expiration_date = ".$db->escape($todaysdate);
$sql.= " WHERE p.expiration_date > '".$todaysdate."'";  
