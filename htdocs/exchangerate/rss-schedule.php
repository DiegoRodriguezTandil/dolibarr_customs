...
mysql_query("INSERT INTO llx_currency_conversion Values ('$Date','USD','ARS','$value')");
...
mysql_query("INSERT INTO llx_currency_conversion Values ('$Date','ARS','USD','$usdtoars')");
...
mysql_query("INSERT INTO llx_currency_conversion Values ('$Date','USD','EUR','$value')");
//--------------------------------------------------------------------------------------------------------
...
mysql_query("INSERT INTO llx_currency_conversion Values ('$Date','EUR','ARS','$value')");
...
mysql_query("INSERT INTO llx_currency_conversion Values ('$Date','ARS','EUR','$eurtoars')");
...
mysql_query("INSERT INTO llx_currency_conversion Values ('$Date','EUR','USD','$value')");
