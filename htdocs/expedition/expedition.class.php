...
class Expedition extends CommonObject
{
    ...
    function update($user=0, $notrigger=0)
    {
		...
		//transportista
		if (isset($this->transportista)) $this->transportista=trim($this->transportista);
		//
		...
		//transportista
		$sql.= " transportista=".(isset($this->transportista)?"'".$this->db->escape($this->transportista)."'":"null").",";
		//
