...
$langs->load("orders");
echo '<br>';
print_titre($langs->trans('Orden de venta relacionada'));
...
<tr <?php echo $GLOBALS['bc'][$var]; ?> ><td>
	<a href="<?php echo DOL_URL_ROOT.'/salesorder/fiche.php?id='.$object->id ?>"><?php echo img_object($langs->trans("ShowOrder"),"salesorder").' '.$object->ref; ?></a></td>
