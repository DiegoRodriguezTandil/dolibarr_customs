...
class ExchangeRate extends CommonObject
{
	...
	/*
		...
		*/
		...
		$sql = "SELECT f.date, f.source, f.target, f.rate";
		$sql.= " FROM ".MAIN_DB_PREFIX."currency_conversion as f";
		if ($ref) $sql.= " WHERE f.date='".$this->db->escape($date)."'";
		else $sql.= " WHERE f.date=".$date;
