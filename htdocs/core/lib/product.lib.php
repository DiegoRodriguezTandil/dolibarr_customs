...
function measuring_units_string($unit,$measuring_style='')
{
	...
	else if ($measuring_style == 'measure')
	{
		$measuring_units[0] = $langs->trans("MeasureEa");
		$measuring_units[1] = $langs->trans("MeasureMts");
		$measuring_units[2] = $langs->trans("MeasureFeet");
	}
