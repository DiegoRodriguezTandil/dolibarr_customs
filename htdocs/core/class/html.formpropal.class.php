            ...
            if ($num)
            {
                while ($i < $num)
                {
                    ...
                    else
                    {
						...
						$conv_to_new_code=array('PR_DRAFT'=>'Draft','PR_OPEN'=>'Opened','PR_CLOSED'=>'Closed','PR_SIGNED'=>'Approved','PR_NOTSIGNED'=>'Not Approved','PR_FAC'=>'Billed');
						...
						print ($langs->trans("PropalStatus".$key.($short?'Short':''))!="PropalStatus".$key.($short?'Short':''))?$langs->trans("PropalStatus".$key.($short?'Short':'')):$langs->trans($obj->label);
                    }
                    print '</option>';
                    $i++;
                }
