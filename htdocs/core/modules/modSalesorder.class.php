...
/**
 *		\defgroup   salesorder     Module orders
 *		\brief      Module pour gerer le suivi des salesorders
 *		\file       htdocs/core/modules/modSalesorder.class.php
 *		\ingroup    salesorder
 *		\brief      Fichier de description et activation du module Salesorder
 */
...
class modSalesorder extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->description = "Gestion des salesorders clients";
		...
		// Config pages
		$this->config_page_url = array("salesorder.php");
		...
		$this->const[$r][0] = "SALESORDER_ADDON_PDF";
		...
		$r++;
		$this->const[$r][0] = "SALESORDER_ADDON";
		$this->const[$r][1] = "chaine";
		$this->const[$r][2] = "mod_salesorder_marbre";
		$this->const[$r][3] = 'Name of numbering numerotation rules of order';
		$this->const[$r][4] = 0;

		$r++;
		$this->const[$r][0] = "SALESORDER_ADDON_PDF_ODT_PATH";
		$this->const[$r][1] = "chaine";
		...
		// Boites
		$this->boxes = array();
		$this->boxes[0][1] = "box_salesorders.php";
		...
		$r++;
		$this->rights[$r][0] = 81;
		$this->rights[$r][1] = 'Lire les salesorders clients';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 1;
		...
		$r++;
		$this->rights[$r][0] = 82;
		$this->rights[$r][1] = 'Creer/modifier les salesorders clients';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		...
		$r++;
		$this->rights[$r][0] = 84;
		$this->rights[$r][1] = 'Valider les salesorders clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		...
		$r++;
		$this->rights[$r][0] = 86;
		$this->rights[$r][1] = 'Envoyer les salesorders clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		...
		$r++;
		$this->rights[$r][0] = 87;
		$this->rights[$r][1] = 'Cloturer les salesorders clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		...
		$r++;
		$this->rights[$r][0] = 88;
		$this->rights[$r][1] = 'Annuler les salesorders clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		...
		$r++;
		$this->rights[$r][0] = 89;
		$this->rights[$r][1] = 'Supprimer les salesorders clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Exporter les salesorders clients et attributs';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'salesorder';
		...
		$this->export_sql_end[$r]  =' FROM ('.MAIN_DB_PREFIX.'salesorder as c, '.MAIN_DB_PREFIX.'societe as s, '.MAIN_DB_PREFIX.'salesorderdet as cd)';
		$this->export_sql_end[$r] .=' LEFT JOIN '.MAIN_DB_PREFIX.'product as p on (cd.fk_product = p.rowid)';
		$this->export_sql_end[$r] .=' WHERE c.fk_soc = s.rowid AND c.rowid = cd.fk_salesorder';
