...
/**
 *	\file       htdocs/core/modules/salesorder/doc/doc_generic_order_odt.modules.php
 *	\ingroup    salesorder
 ...
 */
class doc_generic_order_odt extends ModelePDFSalesorders
{
	...
	function __construct($db)
	{
		...
		$this->scandir = 'SALESORDER_ADDON_PDF_ODT_PATH';	// Name of constant that is used to save list of directories to scan
		...
		$this->option_tva = 0;                     // Gere option tva SALESORDER_TVAOPTION
	...
	function info($langs)
	{
		...
		$texte.= '<input type="hidden" name="param1" value="SALESORDER_ADDON_PDF_ODT_PATH">';
		$texte.= '<table class="nobordernopadding" width="100%">';

		// List of directories area
		$texte.= '<tr><td>';
		$texttitle=$langs->trans("ListOfDirectories");
		$listofdir=explode(',',preg_replace('/[\r\n]+/',',',trim($conf->global->SALESORDER_ADDON_PDF_ODT_PATH)));
		$listoffiles=array();
		...
		$texte.=$conf->global->SALESORDER_ADDON_PDF_ODT_PATH;
		$texte.= '</textarea>';
        $texte.= '</td>';
	 ...
	 *
	 *	@param	Salesorder	$object					Object source to build document
	...
	function write_file($object,$outputlangs,$srctemplatepath)
	{
		...
		if ($conf->salesorder->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				dol_mkdir($conf->salesorder->dir_temp);
				...
				// Line of free text
				$newfreetext='';
				$paramfreetext='SALESORDER_FREE_TEXT';
				...
				$odfHandler = new odf(
				    $srctemplatepath,
				    array(
						'PATH_TO_TMP'	  => $conf->salesorder->dir_temp,
