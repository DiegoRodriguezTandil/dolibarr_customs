...
$sql.= " d.rowid, d.type, d.dated as dd, d.km, d.fk_currency, d.total_ht, ";		// Comment
$sql.= " d.fk_statut,";
...
if ($resql)
{
    ...
    print_liste_field_titre($langs->trans("Currency"),$_SERVER["PHP_SELF"],"s.nom","","&socid=$socid",'',$sortfield,$sortorder);
	print_liste_field_titre($langs->trans("Importe"),$_SERVER["PHP_SELF"],"d.total_ht","","&socid=$socid",'align="right"',$sortfield,$sortorder);
    ...
    while ($i < min($num,$limit))
    {
		...
		//FEDE
		print '<td align="right">'.$obj->fk_currency.'</td>';
